...
public class EmergentPredictionManager extends PredictionManager{


	private static final String engineName = "emergent";
	public EmergentPredictionManager() {
		super(engineName);
	}
	...
	protected boolean startManagedProcess(Request r) {
		ProcessBuilder pb = new ProcessBuilder("python", "RunEmergent.py", "-r", "" + r.getRequestId(), "-p");
